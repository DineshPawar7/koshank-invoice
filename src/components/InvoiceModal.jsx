                  ...
                  <table className="w-full border border-black text-center">
                    ...
                    <tbody>
                      {items.map((item) => (
                        <tr
                          key={item.id}
                          className="border-r border-black text-[10px]"
                        >
                      ...
                      <tr className="border-l border-black text-[11px] font-bold">
                      ...
                      <tr className="border border-black text-[11px] font-bold">
                        <td className="border border-black px-2 py-1 font-normal">
                          Remaining Payment:
                        </td>
                        <td className="border border-black px-2 py-1">
                          ₹{totalQuantity}
                        ...
                        <td className="border border-black px-2">
                          ₹{(totalCost - totalAdvance).toFixed(2)}
                        </td>
                      </tr>
                    </tbody>
                  </table>
